...
export const BID_ON_ORDER_REQUEST = 'BID_ON_ORDER_REQUEST';
export const BID_ON_ORDER_SUCCESS = 'BID_ON_ORDER_SUCCESS';
export const BID_ON_ORDER_FAIL = 'BID_ON_ORDER_FAIL';

export const SELECT_BID_REQUEST = 'SELECT_BID_REQUEST';
export const SELECT_BID_SUCCESS = 'SELECT_BID_SUCCESS';
export const SELECT_BID_FAIL = 'SELECT_BID_FAIL';

export const CHANGE_STATUS_REQUEST = 'CHANGE_STATUS_REQUEST';
export const CHANGE_STATUS_SUCCESS = 'CHANGE_STATUS_SUCCESS';
export const CHANGE_STATUS_FAIL = 'CHANGE_STATUS_FAIL';

export const COMPLAIN_ON_ORDER_REQUEST = 'COMPLAIN_ON_ORDER_REQUEST';
export const COMPLAIN_ON_ORDER_SUCCESS = 'COMPLAIN_ON_ORDER_SUCCESS';
export const COMPLAIN_ON_ORDER_FAIL = 'COMPLAIN_ON_ORDER_FAIL';
